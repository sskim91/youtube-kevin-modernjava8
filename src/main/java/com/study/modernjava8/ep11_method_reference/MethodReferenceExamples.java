package com.study.modernjava8.ep11_method_reference;
...
//            .sorted((bd1, bd2) -> bd1.compareTo(bd2))
        ...
        //enum테스트
        System.out.println("\nenum(TYPE.GRADEC::equals)\n" +
                abcdList.stream()
                        .anyMatch(TYPE.GRADEC.getTypeName()::equals)
        );

        System.out.println(TYPE.GRADEC.getTypeName());
