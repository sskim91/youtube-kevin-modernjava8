package com.study.modernjava8.e08_03_stream_03;
...
public class StreamExamples3 {
    public static void main(String[] args) {
        ...
        /**
         *  Equality가 아닌 Identity를 확인
         *  Equality: equals()를 통해확인
         *  Identity: ==를 이용해 메모리 레퍼런스 확인
         *  Integer는 -128~127까지 캐싱을 사용. (Integer클래스 986라인부터 확인)
         *  그래서 == 127은 같은것으로 간주하지만 128부터는 다른 주소값을 비교하기때문에 false가 된다.
         */
